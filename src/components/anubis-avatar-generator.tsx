    ...
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center gap-12">
      ...
      {originalImage && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          <div className="flex flex-col items-center gap-2">
            <h2 className="text-2xl font-bold text-center">Generated</h2>
            <Card className="w-full aspect-square relative overflow-hidden bg-card/50">
              {isLoading && (
              ...
              {generatedImage ? (
                ...
                !isLoading && <div className="w-full h-full bg-secondary"></div>
              )}
            </Card>
          </div>
        </div>
      ...
      {originalImage && (
        <div className="flex flex-col items-center gap-8 w-full max-w-xl">
          <div className="text-center">
            <h3 className="text-3xl font-bold">Generate Your Avatar</h3>
